...
3. **Генерация:** Отправка контекста и вопроса в Mistral AI
4. **Ответ:** Получение и отображение результата
...
**v0.0.1** - Первая версия системы с базовым функционалом RAG.
